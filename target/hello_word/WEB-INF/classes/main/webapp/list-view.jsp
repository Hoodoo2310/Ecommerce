        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9  col-sm-8">
                    <div id="right">
                        <div class="category-banner"> <a href="#"><img src="${categorie.getUrlPhoto()}" alt="#"></a> </div>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="product-list-view">
                            <ul>
                                <c:forEach items="${ listProdByCat }" var="produit">
                                    <li>
                                        <div class="product-block ">
                                            <div class="item col-md-4 col-sm-6 col-xs-4">
                                                <div class="image"> <a href="/detail_produit?id=${produit.getId()}"><img class="img-responsive" title="${produit.getNom()}" alt="${produit.getNom()}" src="${produit.getUrl_photo()}"></a> </div>
                                            </div>
                                            <div class="item col-md-8 col-sm-6 col-xs-8">
                                                <div class="product-details">
                                                    <div class="product-name">
                                                        <h4><a href="/detail_produit?id=${produit.getId()}">${produit.getNom()} </a></h4>
                                                    </div>
                                                    <div class="review">
                                                        <span class="rate">
